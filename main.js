...
/*--------Btn Next------- */
document.getElementById('nextButtoninsta').addEventListener('click', function() {
  // Redirect to the next website
  window.location.href = 'https://www.instagram.com/developer_priyank/';
});
document.getElementById('nextButtonlink').addEventListener('click', function() {
  window.location.href = 'https://www.linkedin.com/in/priyankpanchal-coder0911/';
});
document.getElementById('nextButtongithub').addEventListener('click', function() {
  window.location.href = 'https://github.com/Priyank911';
});
